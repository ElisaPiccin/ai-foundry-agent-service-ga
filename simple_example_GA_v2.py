...
# Set your Azure AI Foundry project endpoint from environment variable
project_endpoint = os.getenv("AI_FOUNDRY_PRJ_ENDPOIN")
...
with project_client:
    ...
    message = project_client.agents.messages.create(
        thread_id=thread.id,
        role="user",
        content="Who is the latest national team to win Europen basketball championship?",
    )
